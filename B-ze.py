#!/usr/bin/env python3
'''
Script que haga esto con la secuencia "ATGAAACCCGGGTTTTAA":

1-Imprima la longitud
2-Cuente cada nucleótido (A, T, G, C)
3-Calcule el contenido GC usando una función
4-Imprima la secuencia de ARN (reemplaza T → U)
'''
import sys
#Funciones
def count_gc(seq_p):
